...
type FunctionApi interface {
	...
	*/
	...
	//  @return []GetFunctionResponseInner
	GetFunctionsExecute(r FunctionApiGetFunctionsRequest) ([]GetFunctionResponseInner, *http.Response, error)
}
...
func (r FunctionApiGetFunctionsRequest) Execute() ([]GetFunctionResponseInner, *http.Response, error) {
...
// Execute executes the request
//  @return []GetFunctionResponseInner
func (a *FunctionApiService) GetFunctionsExecute(r FunctionApiGetFunctionsRequest) ([]GetFunctionResponseInner, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []GetFunctionResponseInner
	)
